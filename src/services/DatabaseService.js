...
class DatabaseService {
  ...
  static async getCurrentShift() {
    try {
      const currentShiftData = await AsyncStorage.getItem(STORAGE_KEYS.CURRENT_SHIFT);
  ...
  static async saveCurrentShift(shift) {
    try {
      await AsyncStorage.setItem(STORAGE_KEYS.CURRENT_SHIFT, JSON.stringify(shift));
    } catch (error) {
  ...
  static async getWorkStatus() {
    try {
      return await AsyncStorage.getItem(STORAGE_KEYS.WORK_STATUS) || 'inactive';
    } catch (error) {
  ...
  static async getStatusHistory() {
    try {
      const historyData = await AsyncStorage.getItem(STORAGE_KEYS.STATUS_HISTORY);
  ...
  static async saveStatusHistory(history) {
    try {
      await AsyncStorage.setItem(STORAGE_KEYS.STATUS_HISTORY, JSON.stringify(history));
    } catch (error) {
  ...
  static async saveWeeklyStatus(weeklyStatus) {
    try {
      await AsyncStorage.setItem(STORAGE_KEYS.WEEKLY_STATUS, JSON.stringify(weeklyStatus));
    } catch (error) {
  ...
  static async getStatusDetails() {
    try {
      const detailsData = await AsyncStorage.getItem(STORAGE_KEYS.STATUS_DETAILS);
  ...
  static async saveStatusDetails(details) {
    try {
      await AsyncStorage.setItem(STORAGE_KEYS.STATUS_DETAILS, JSON.stringify(details));
    } catch (error) {
  ...
  static async saveWorkEntries(entries) {
    try {
      await AsyncStorage.setItem(STORAGE_KEYS.WORK_ENTRIES, JSON.stringify(entries));
    } catch (error) {
