...
export const vi = {
  ...
  must_check_out_first_message:
    "Bạn cần chấm công ra trước khi hoàn thành ca làm.",
  ...
  notes_note_title_duplicate:
    "Tiêu đề này đã tồn tại, vui lòng chọn một tiêu đề khác",
  ...
  check_in_time_warning:
    "Bạn đang thực hiện chấm công vào quá sớm sau khi đi làm. Cần ít nhất 5 phút (còn thiếu {{minutes}} phút). Bạn có muốn tiếp tục?",
  check_out_time_warning:
    "Bạn đang thực hiện tan làm quá sớm sau khi chấm công vào. Cần ít nhất 2 giờ (còn thiếu {{hours}} giờ). Bạn có muốn tiếp tục?",
  validation_must_go_work_first:
    "Bạn cần thực hiện hành động Đi Làm trước khi Chấm Công Vào",
  validation_must_check_in_first:
    "Bạn cần thực hiện hành động Chấm Công Vào trước khi Tan Làm",
  validation_must_check_out_first:
    "Bạn cần thực hiện hành động Tan Làm trước khi Hoàn Tất",
  ...
  confirm_reset_form_message:
    "Bạn có chắc chắn muốn đặt lại biểu mẫu này không?",
  ...
  confirm_early_check_out:
    "Bạn đang thực hiện check-out sớm hơn thởi gian quy định (cần ít nhất 2 giờ sau khi check-in). Bạn có chắc chắn muốn tiếp tục?",
  confirm_action_message: "Bạn có chắc chắn muốn thực hiện hành động này?",
  continue: "Tiếp tục",
  reset_day_confirm:
    "Bạn có chắc chắn muốn đặt lại trạng thái làm việc của ngày hôm nay?",
  time_validation_check_in:
    'Bạn đang thực hiện check-in quá sớm sau khi bấm nút "Đi làm". Bạn có muốn tiếp tục?',
  time_validation_check_out:
    "Bạn đang thực hiện check-out quá sớm sau khi check-in. Bạn có muốn tiếp tục?",
...
export const en = {
  ...
  dark_mode: "Dark Mode",
  dark_mode_description:
    "Enable dark mode for better viewing experience in low light conditions",
  ...
  confirm_early_check_out:
    "You are checking out earlier than the scheduled time (at least 2 hours after checking in). Are you sure you want to continue?",
  ...
  time_validation_check_in:
    'You are checking in too soon after you pressed "Go to Work". You need to wait at least 5 minutes. Do you want to continue?',
  time_validation_check_out:
    "You are checking out too soon after checking in. You need to wait at least 2 hours. Do you want to continue?",
