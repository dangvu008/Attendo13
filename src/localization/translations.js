...
export const vi = {
  ...
  must_go_work_first: 'Bạn cần bấm "Đi làm" trước khi chấm công vào.',
  must_check_in_first: 'Bạn cần chấm công vào trước khi chấm công ra.',
  must_check_out_first: 'Bạn cần chấm công ra trước khi hoàn thành ca làm.',
  ...
  regular_hours: 'Giờ làm việc thường',
  hours: 'giờ',
  ...
  save_note_error: 'Không thể lưu ghi chú, vui lòng thử lại',
  confirm_reset: 'Xác nhận xóa nội dung',
  confirm_reset_message: 'Bạn có chắc chắn muốn xóa tất cả nội dung đã nhập?',
  ...
  applied_days: 'Các ngày áp dụng',
  note_color: 'Màu sắc ghi chú',
  note_tags: 'Thẻ gắn',
  ...
  must_go_work_first: 'Bạn cần thực hiện hành động Đi Làm trước khi Chấm Công Vào',
  must_check_in_first: 'Bạn cần thực hiện hành động Chấm Công Vào trước khi Tan Làm',
  must_check_out_first: 'Bạn cần thực hiện hành động Tan Làm trước khi Hoàn Tất',
  ...
  save_note_confirm: 'Bạn có chắc chắn muốn lưu ghi chú này?',
  exit_note_confirm: 'Bạn có muốn thoát mà không lưu ghi chú?',
  continue_editing: 'Tiếp tục chỉnh sửa',
  exit: 'Thoát',
...
export const en = {
  ...
  must_go_work_first: 'You need to tap "Go to Work" before checking in.',
  must_check_in_first: 'You need to check in before checking out.',
  must_check_out_first: 'You need to check out before completing your shift.',
  ...
  save_note_error: 'Cannot save note, please try again',
  confirm_reset: 'Confirm Reset',
  confirm_reset_message: 'Are you sure you want to clear all entered content?',
  ...
  must_go_work_first: 'You need to Go To Work before you can Check In',
  must_check_in_first: 'You need to Check In before you can Check Out',
  must_check_out_first: 'You need to Check Out before you can Complete',
  ...
  reminder_time: 'Reminder Time',
  save_note_confirm: 'Are you sure you want to save this note?',
  exit_note_confirm: 'Do you want to exit without saving note?',
  continue_editing: 'Continue Editing',
  exit: 'Exit',
  repeat_on: 'Repeat on',
