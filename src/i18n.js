...
const resources = {
  en: {
    ...
    time_validation_check_in: 'You should wait at least 5 minutes after going to work before checking in. Do you want to continue anyway?',
    time_validation_check_out: 'You should work at least 2 hours before checking out. Do you want to continue anyway?',
  ...
  vi: {
    ...
    time_validation_check_in: 'Bạn nên đợi ít nhất 5 phút sau khi đi làm trước khi chấm công vào. Bạn có muốn tiếp tục?',
    time_validation_check_out: 'Bạn nên làm việc ít nhất 2 giờ trước khi chấm công ra. Bạn có muốn tiếp tục?',
